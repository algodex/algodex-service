...
fn get_analytics_per_escrow(inputted_asset_id: &u32,
    state_machine: &StateMachine,
    initial_state: &InitialState) -> Vec<QualityResult> {
...
fn get_owner_wallet_to_quality<'a>(initial_state: &'a InitialState,
    quality_analytics: &'a [QualityResult]) -> HashMap<&'a String, QualityResult> {
...
fn update_owner_wallet_quality(owner_wallet_asset_to_rewards: &mut HashMap<String, HashMap<u32, OwnerRewardsResult>>,
    owner_wallet_to_quality: &HashMap<&String, QualityResult>,
    asset_id: &u32, unix_time: &u32, total_bid_depth: &BidDepth, total_ask_depth: &AskDepth
    ) {
...
pub fn update_rewards(
    ...
    let quality_analytics = get_analytics_per_escrow(inputted_asset_id, state_machine, initial_state);
    ...
    update_owner_wallet_quality(owner_wallet_asset_to_rewards, &owner_wallet_to_quality,inputted_asset_id, timestep,
