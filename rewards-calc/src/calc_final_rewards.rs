...
use crate::{state_machine::StateMachine, update_owner_liquidity_quality::{OwnerRewardsKey, EarnedAlgxEntry, OwnerWalletAssetQualityResult, MainnetPeriod}, quality_type::{EarnedAlgx, Quality}, initial_state::get_seconds_in_epoch};


fn get_total_quality(state_machine: &StateMachine, mainnet_period: &MainnetPeriod) ->
...
pub fn get_owner_rewards_res_to_final_rewards_entry(state_machine: &StateMachine
